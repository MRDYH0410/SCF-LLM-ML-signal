...
def aggregate_scores_by_firm_time(
    ...
    返回：
        pd.DataFrame: 聚合结果，列为 score_name，各行对应 (firm_id, date)
    """
...
if __name__ == "__main__":
    sample_data = [
        {"firm_id": "BYD", "date": "2025-05-01", "score_name": "reputation_finbert", "score_value": 0.2},
        {"firm_id": "BYD", "date": "2025-05-01", "score_name": "reputation_finbert", "score_value": -0.4},
        {"firm_id": "BYD", "date": "2025-05-01", "score_name": "executive_signal", "score_value": 0.6},
        {"firm_id": "BYD", "date": "2025-05-01", "score_name": "executive_signal", "score_value": 0.8},
        {"firm_id": "TSLA", "date": "2025-05-01", "score_name": "reputation_finbert", "score_value": -0.1},
    ]
